...
{SPEAKER_MALE}: خوب بریم با هم مروری داشته باشیم بر روی مطالب کانال‌های تلگرامی فعال دیروز.
...
{SPEAKER_FEMALE}: هر روز منتظر انتشار پادکست‌های صوتی روزانه از کوهنامه باشید و پادکست‌های ما را با دوستان کوهنورد خود در گروه ها به اشتراک بگذارید.
{SPEAKER_MALE}: تا پادکست صبحگاهی فردا، خدا نگهدارتون باشه.
